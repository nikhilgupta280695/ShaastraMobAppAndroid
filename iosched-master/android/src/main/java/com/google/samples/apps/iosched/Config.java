...
public class Config {
    ...
    // Conference hashtag
    public static final String CONFERENCE_HASHTAG = "#shaastra";
    ...
    public static final String CONFERENCE_HASHTAG_PREFIX = "#shaastra";
    ...
    public static final long[][] CONFERENCE_DAYS = new long[][] {
            ...
            { ParserUtils.parseTime("2015-01-03T07:00:00.000Z"),
              ParserUtils.parseTime("2015-01-04T06:59:59.999Z") },
            // start and end of day 2
			{ ParserUtils.parseTime("2015-01-04T07:00:00.000Z"),
					ParserUtils.parseTime("2015-01-05T06:59:59.999Z") },
        };

    public static final TimeZone CONFERENCE_TIMEZONE = TimeZone.getTimeZone("India/Chennai");
    ...
    public static final String APP_NAME = "Shaastra";
    public static final String API_KEY = "AIzaSyCSDYrZOVcqz1UQ161eCJjHL7eBRQZOq9o";
