...
public class MapFragment extends com.google.android.gms.maps.MapFragment implements
    ...
    private static final LatLng MOSCONE =  new LatLng(12.992316,80.236711);
    private static final LatLng MOSCONE_CAMERA =  new LatLng(12.992316,80.236711);

    // Initial camera zoom
    private static final float CAMERA_ZOOM = 15.19f;
    private static final float CAMERA_BEARING = 0f;
