        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_social_stream:
                if (!TextUtils.isEmpty(mHashTag)) {
                     ...
                     * [/ANALYTICS]
                     */
					//Intent in=new Intent(this.getActivity(),PrizeMoney.class);
					//startActivity(in);
					AlertDialog.Builder builder = new AlertDialog.Builder(this.getActivity());
					builder.setTitle("Prizes to be Won")
							.setMessage("Prizes for sure..!! Check website for more info :)")
							.setCancelable(true)
					...
					final AlertDialog prize = builder.create();
